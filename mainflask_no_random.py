...
def index():
    ...
    #rescale image
    #luu anh__SONPIPI___
    img_AnhTong = Image.open("imgs/anhtam3.jpg")
    width, height = img_AnhTong.size
    #__END_SONPIPI___
    ...
    img_cropped1 = img_AnhTong.crop((0, 0, width//2 -40, height))
    # lưu ảnh đã cắt
    img_cropped1.save("imgs/img_1.jpg")
    # cắt lấy nửa ảnh đầu trên
    img_cropped2 = img_AnhTong.crop((width//2-40, 0, width, height))
    # lưu ảnh đã cắt
