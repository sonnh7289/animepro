...
def index():
    ...
    #rescale image
    #luu anh__SONPIPI___
    img_AnhTong1 = Image.open("imgs/anhtam3.jpg")
    width_AnhTong1, height_AnhTong1 = img_AnhTong1.size
    img_AnhTong2 = Image.open("imgs/anhtam4.jpg")
    width_AnhTong2, height_AnhTong2 = img_AnhTong2.size
    #__END_SONPIPI___
    ...
    #img = Image.open(f"imgs/couple{index}.jpg")
    ...
    img_cropped1 = img_AnhTong1.crop((0, 0, width_AnhTong1//2 -40, height_AnhTong1))
    # lưu ảnh đã cắt
    img_cropped1.save("imgs/img_1.jpg")
    # cắt lấy nửa ảnh đầu trên
    img_cropped2 = img_AnhTong2.crop((width_AnhTong2//2-40, 0, width_AnhTong2, height_AnhTong2))
    # lưu ảnh đã cắt
